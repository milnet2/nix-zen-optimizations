...
#    "Go environment" = let
#        buildInfoProgram = pkgsTuned.callPackage ./test/example-programs/buildinfo-go {};
#        buildInfoJson = builtins.fromJSON (builtins.readFile "${buildInfoProgram}/lib/buildinfo.json"); # Json was created by executing program
#    in {
...
#    "Julia environment" = let
#        buildInfoProgram = pkgsTuned.callPackage ./test/example-programs/buildinfo-julia {};
...
#    "R environment" = let
#        buildInfoProgram = pkgsTuned.callPackage ./test/example-programs/buildinfo-r {};
#        buildInfoJson = builtins.fromJSON (builtins.readFile "${buildInfoProgram}/lib/buildinfo.json");
#    in {
#        "test target arch is x86_64" = {
#            expr = buildInfoJson.target.arch;
...
#    "Optimized Haskell compilation" = let
#        buildInfoProgram = pkgsTuned.callPackage ./test/example-programs/buildinfo-haskell {};
#        buildInfoJson = builtins.fromJSON (builtins.readFile "${buildInfoProgram}/lib/buildinfo.json");
#    in {
#        "test target arch is x86_64" = {
#            expr = buildInfoJson.target.arch;
#            expected = "x86_64";
#        };
#        "test ghc version format" = {
#            expr = builtins.match "ghc [0-9]+\\.[0-9]+(\\.[0-9]+)?" buildInfoJson.compiler.version_string != null;
#            expected = true;
#        };
#        "test fastmath" = {
#            expr = buildInfoJson.compiler.fast_math;
...
#        };
#    };
    "Optimized Zig compilation" = let
        buildInfoProgram = pkgsTuned.callPackage ./test/example-programs/buildinfo-zig {};
        buildInfoJson = builtins.fromJSON (builtins.readFile "${buildInfoProgram}/lib/buildinfo.json");
    in {
        "test target arch is x86_64" = {
            expr = buildInfoJson.target.arch;
