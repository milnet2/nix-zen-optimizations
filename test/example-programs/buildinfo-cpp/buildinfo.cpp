 ...
 *
 * If you want to embed the exact g++ command that built this binary, compile with:
 *   g++ ... -DCX_ARGS="\"g++ <your flags here>\"" buildinfo.cpp -o buildinfo
...
int main() {
    ...
    // C++ specific compiler information
#ifdef __cplusplus
    js_kv_int("cpp_version", __cplusplus, 1);
#else
    js_kv_str("cpp_version", NULL, 1);
#endif
...
#ifdef CX_ARGS
    js_kv_str("embedded_cx_command", CX_ARGS, 0);
#else
    js_kv_str("embedded_cx_command", NULL, 0);
#endif
